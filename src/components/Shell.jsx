...
// The marque lives in its own file so the top bar, the report sheet and the
// browser tab cannot drift apart. See src/components/Marque.jsx.
export { Mark, Wordmark } from "./Marque.jsx";
